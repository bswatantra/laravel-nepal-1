      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid gap-8 grid-cols-4 lg:grid-cols-6">
          ...
          <div className="col-span-4 lg:col-span-2 max-w-2xl">
            ...
            <div className="flex space-x-4 max-lg:justify-center text-red-500">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-2">
          <div className="flex flex-col sm:flex-row items-center gap-2 text-muted-foreground text-sm">
            <div className="flex items-center gap-1">
              ...
              <span>by</span>
              <a href="https://Laravel Nepal.com" target='_blank' className="font-semibold hover:text-primary transition-colors cursor-pointer text-red-500">
                Laravel Nepal
              </a>
            </div>
          ...
          <div className="flex items-center space-x-4 text-sm text-muted-foreground mt-4 md:mt-0">
            ...
            <a href="#cookies" className="hover:text-red-500 transition-colors">
              Cookie Policy
            </a>
          </div>
        </div>
