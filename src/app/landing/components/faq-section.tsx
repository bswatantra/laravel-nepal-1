...
const faqItems: FaqItem[] = [
  {
    value: 'item-1',
    question: 'How do I integrate Laravel Nepal components into my project?',
    answer:
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Everything you need to know about Laravel Nepal components, licensing, and integration. Still have questions? We&apos;re here to help!
          </p>
        </div>
